...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:checkpoint:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","C:\\Users\\studentTIM\\IdeaProjects\\checkpoint-plugin");
    parameters.put("artifactId","checkpoint");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\Users\\studentTIM\\IdeaProjects\\checkpoint-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Users\\studentTIM\\IdeaProjects\\checkpoint-plugin\\target\\test-classes");
